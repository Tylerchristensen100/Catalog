...
describe('Edit Program autofills fields', () => {
    it('passes', () => {
        ...
        cy.visit('http://localhost:3100/admin/programs')
...
describe('Edit Program', () => {
    it('passes', () => {
        ...
        cy.visit('http://localhost:3100/admin/programs')
        cy.intercept('/api/programs').as('getPrograms')
        cy.intercept('/api/admin/programs').as('PUTProgram')
        ...
        cy.get('input[name="major_code"]').type('ACC')


        cy.get('button').contains("Submit").click();

        cy.wait('@PUTProgram').then((interception) => {
